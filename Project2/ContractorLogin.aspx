<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractorLogin.aspx.cs" Inherits="Project2.ContractorLogin" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="auto-style8">
            <strong>
            <asp:Label ID="Label1" runat="server" CssClass="auto-style7" Text="Contractor log-in"></asp:Label>
            </strong>
